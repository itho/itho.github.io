...
AnimationRecord.prototype = {
  ...
  createKeyframeAnimation: function() {
    ...
    if ((this.nodeName === 'animate' ||
      ...
      // If the interpolation mode is 'paced', the â€˜keyTimesâ€™ attribute is
      // ignored. If the simple duration is indefinite, any â€˜keyTimesâ€™
      ...
      if (this.values) {
        ...
        // http://www.w3.org/TR/SVG/animate.html#KeyTimesAttribute
        // For animations specified with a â€˜valuesâ€™ list, the â€˜keyTimesâ€™
        // attribute if specified must have exactly as many values as there
        // are in the â€˜valuesâ€™ attribute.
        ...
        // http://www.w3.org/TR/SVG/animate.html#KeyTimesAttribute
        // For from/to/by animations, the â€˜keyTimesâ€™ attribute if specified
    ...
    // This attribute is ignored unless the â€˜calcModeâ€™ is set to 'spline'.
  ...
  createMotionPathAnimation: function() {
    ...
    // http://www.w3.org/TR/SVG/animate.html#AnimateMotionElement
    // Regarding the definition of the motion path, the â€˜mpathâ€™ element
    // overrides the â€˜pathâ€™ attribute, which overrides â€˜valuesâ€™, which
    // overrides â€˜fromâ€™, â€˜byâ€™ and â€˜toâ€™.
    if (!resolvedPath) {
