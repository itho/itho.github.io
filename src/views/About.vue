    ...
    <v-layout row wrap text-xs-center>
      <v-flex xs12 sm8 offset-sm2>
        <v-card>
          ...
          <v-card-text>
            <p>We love to use the latest technologies to create the most beautiful and responsive web and mobile applications.</p>
            <p class="showcase">
              <a href="https://developer.mozilla.org/en/docs/Web/Guide/HTML/HTML5"><img src="/static/img/logo-html5.png"/></a>
