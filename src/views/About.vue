        ...
        <v-layout row wrap align-center>
          <v-flex xs12>
            <v-card class="elevation-0 transparent">
              ...
              <v-card-title primary-title class="layout justify-center">
                <div class="headline text-xs-center">What we're about...</div>
              </v-card-title>
              <v-card-text>
                <p class="text-xs-center">We love to use the latest technologies to create the most beautiful and responsive web and mobile applications.</p>
          ...
          <v-flex xs12>
            <v-card class="elevation-0 transparent">
              ...
              <v-card-title primary-title class="layout justify-center">
                <div class="headline text-xs-center">Where we're based...</div>
              </v-card-title>
              <v-card-text>
